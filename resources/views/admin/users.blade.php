                            ...
                            @foreach($users as $user)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                        @if ($user->image)
                                            <img class="w-10 h-10 rounded" alt="img" src="{{ $user->image }}">
                                        @else
                ...
                <form action="{{ route('admin.users.store') }}" method="post">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid gap-5">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="phone-number" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                                <input id="email" type="text" name="email" class="shadow-lg-sm border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5" placeholder="Email" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select name="type" class="border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5">
