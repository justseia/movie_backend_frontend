                ...
                <div class="middle-footer">
                    <div class="row">
                        <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 md-mb25">
                            <h5 style="color: #FFFFFF;font-size: 40px; font-weight: 800;">Eazytick</h5>
                            <h3 style="color: #70FFFFFF;font-size: 22px; font-weight: 400;">Platform for a good mood</h3>
                        </div>
                        <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 md-mb25">
                            <h5>About us</h5>
                            <ul>
                                ...
                                <li><a href="{{ route('privacy-policy.index') }}">Terms of use</a></li>
                                <li><a href="{{ route('privacy-policy.index') }}">Ticket return policy</a></li>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('theater.index') }}">Theaters</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6">
                            <h5>Possibilities</h5>
                            <ul>
                                <li><a href="{{ route('trailer.index') }}">Buy tickets together</a></li>
                                <li><a href="{{ route('event.index') }}">Find friends</a></li>
                                <li><a href="{{ route('chatify') }}">Chat with new friends</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
